<%-- 
    ...
    Created on : 23-abr-2014, 19:32:46
...
<html>
    ...
    <body>
        <b>Búsqueda por Categoria</b>
        <form action='ServletListaProductos?busqueda=categoria'>
            <select name='query'>
            ...
            <input type='hidden' name='busqueda' value='categoria'>
        </form>
        
        <table>
            <tr><td><b>Nombre</b></td><td><b>Precio</b></td><td><b>Categoria</b></td><tr>
            <c:forEach var="producto" items="${listaProductosCategoria}" varStatus="contador">
